...
- MUST: Read the learnings before implementing — the project's `docs/learnings/INDEX.md`, when it exists — opening `{slug}/{slug}.md` for the ones that touch this work, and pass the relevant learnings to every agent you dispatch.

...
Spec-driven skills for Claude Code, synced across machines. Source of truth for the nine skills installed into `~/.claude/skills`.
...
Replaces only the nine skills above in `~/.claude/skills`; any other skill directory is left untouched.
